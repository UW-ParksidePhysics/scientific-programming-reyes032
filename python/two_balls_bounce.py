...
initial_position_2 = vp.vector(-10., 5., 0.)
initial_velocity = vp.vector(20., 10., 0.)
initial_velocity_2 = vp.vector(20., -10., 0.)
ball = vp.sphere(pos=initial_position, radius=0.5, color=vp.color.blue, make_trail=True)
ball_2 = vp.sphere(pos=initial_position_2, radius=0.5, color=vp.color.green, make_trail=True)
