...
#  micheal birth date november(07) my birth month was june(06)
r = arrow(pos=vector(0, 0, 0), axis=vector(6,7,11), color=color.yellow, shaftwidth=0.5)
r_lbl = label(pos=vector(6,7,11), text="06x̂ + 07ŷ + 11ẑ", color=color.black, shaftwidth=0.5)
